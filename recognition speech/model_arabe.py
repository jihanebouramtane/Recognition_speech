...
model = Wav2Vec2ForCTC.from_pretrained("C:/Users/admin/Desktop/recognition speech/wav2vec2-ar/kaggle/working/checkpoint-1000")

def transcribe_arabe(audio_path):
